...
if __name__ == "__main__":
    # 北京大学中心点坐标
    min_lat = 39.97313  # 39.9928 - 0.009
    max_lat = 39.99882 # 39.9928 + 0.009
    min_lon = 116.29552 # 116.3055 - 0.011
    max_lon = 116.32634 # 116.3055 + 0.011
    grid_size = 300

    # 生成网格
    grid_polygons = generate_grid_polygons(min_lat, min_lon, max_lat, max_lon, grid_size)
    num_polygons = len(grid_polygons)

    # 生成N*N的数组，元素为10到30之间的整数
    array = [[random.randint(10, 30) for _ in range(num_polygons)] for _ in range(num_polygons)]
