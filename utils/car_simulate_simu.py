...
class LTF_Traci:
    ...
    def _get_edge_types(self):
        ...
        for edge in root.findall('edge'):
            ...
            if edge_id:
                self.edge_id_to_type[edge_id] = edge_type
        print(f"成功加载 {len(self.edge_id_to_type)} 条edge的类型信息")
    ...
    def run(self,need_add=[]):
        ...
        try:
            ...
            for road_id in road_ids:
                ...
                if self.edge_id_to_type[road_id]=='highway.service':
                    continue
